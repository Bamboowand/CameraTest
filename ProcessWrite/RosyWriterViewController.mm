...
@interface RosyWriterViewController () <RosyWriterCapturePipelineDelegate, VisualProcessDelegate>
{
...
#pragma mark- Visual Process Method
...
- (void)viewDidLoad
{
    ...
    _capturePipeline.renderer.delegate = self;
...
#pragma mark- Visual Process Delegate Method
