...
//                UIImage *image = [UIImage imageWithData:data];
                ...
                CIImage *ciImage = [CIImage imageWithCVPixelBuffer:renderedPixelBuffer];
                
                CIContext *temporaryContext = [CIContext contextWithOptions:nil];
                CGImageRef videoImage = [temporaryContext createCGImage:ciImage fromRect:CGRectMake(0,
                                                                                                    0,
                                                                                                    CVPixelBufferGetWidth(renderedPixelBuffer),
                                                                                                    CVPixelBufferGetHeight(renderedPixelBuffer))];
                
                UIImage *uiImage = [UIImage imageWithCGImage:videoImage];
                uiImage = [UIImage imageWithCGImage:uiImage.CGImage scale:uiImage.scale orientation:UIImageOrientationRight];
